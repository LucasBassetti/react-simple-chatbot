...
const SecureChatBotWithoutDelay = props => (
  <SecureChatBot botDelay={0} userDelay={0} customDelay={0} {...props} />
);
...
describe('SecureChatBot', () => {
  ...
  describe('Reloading of chat (using cache)', () => {
    ...
    describe('Reloading at TextStep', () => {
      ...
      const chatBot = <SecureChatBotWithoutDelay cache cacheName={cacheName} steps={steps} />;
  ...
  describe('Last option step can be an end step', () => {
    ...
    const chatBot = <SecureChatBot botDelay={0} userDelay={0} customDelay={0} steps={steps} />;
    ...
    it('should have a text step in rendered steps', () => {
      const renderedSteps = wrapper.find(SecureChatBot).state('renderedSteps');
  ...
  describe('UpdateSteps can assign end to steps', () => {
    ...
    const chatBot = <SecureChatBotWithoutDelay steps={steps} />;
