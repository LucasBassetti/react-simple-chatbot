...
const Donate = () => (
  <div className="docs-donate">
    <p>Coding looks better with a beer :)</p>
    <a href="https://beerpay.io/LucasBassetti/react-simple-chatbot"><img src="https://beerpay.io/LucasBassetti/react-simple-chatbot/badge.svg?style=flat" /></a>
