  ...
  return (function(e) {
    ...
    function(e, t, n) {
      ...
      var R = (function(e) {
        function t() {
          ...
          return (
            ...
            (n = !i || ('object' !== P(i) && 'function' != typeof i) ? N(r) : i),
            M(N(N(n)), 'state', { loading: !0 }),
            M(N(N(n)), 'renderComponent', function() {
              var e = n.props,
                t = e.step,
                r = e.steps,
                i = e.previousStep,
      ...
      var lt = null,
        ...
        ft = (function() {
          function e() {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : pt,
              n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : pt,
              r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : pt,
            ...
            if (window.SpeechSynthesisUtterance && window.speechSynthesis && !a && i) {
              var s = (function(e) {
                  var t = e.message,
                    n = e.metadata,
                    r = void 0 === n ? {} : n;
                  return St(r.speak) ? r.speak : St(t) ? t : '';
                })(t),
      ...
      var Ct = (function(e) {
        function t(e) {
          ...
          return (
            ...
            zt(Pt(Pt(n)), 'generateRenderedStepsById', function() {
            ...
            zt(Pt(Pt(n)), 'triggerNextStep', function(e) {
              ...
              if (
                ...
                delete l.options,
                  (l = wt({}, l, d, o, { user: !0, message: d.label, trigger: b })),
                  a.pop(),
                  i.pop(),
                  a.push(l),
                  i.push(l),
                ...
                l.replace && a.pop();
                var h = wt({}, s[n.getTriggeredStep(l.trigger, l.value)]);
                if (h.message) h.message = n.getStepMessage(h.message);
                else if (h.update) {
                  var g = h;
                  if ((h = wt({}, s[g.update])).options)
            ...
            zt(Pt(Pt(n)), 'isInputValueEmpty', function() {
              var e = n.state.inputValue;
              return !e || 0 === e.length;
            }),
            zt(Pt(Pt(n)), 'isLastPosition', function(e) {
            ...
            zt(Pt(Pt(n)), 'isFirstPosition', function(e) {
              var t = n.state.renderedSteps,
                r = t
                  .map(function(e) {
                    return e.key;
            ...
            zt(Pt(Pt(n)), 'handleKeyPress', function(e) {
              'Enter' === e.key && n.submitUserMessage();
            }),
            zt(Pt(Pt(n)), 'handleSubmitButton', function() {
              var e = n.state,
                t = e.speaking,
            ...
            zt(Pt(Pt(n)), 'handleChangeButtton', function() {
              var e = n.state.textMode;
              n.setState({ textMode: !e });
            }),
            zt(Pt(Pt(n)), 'submitUserMessage', function() {
              var e = n.state,
            ...
            zt(Pt(Pt(n)), 'checkInvalidInput', function() {
            ...
            zt(Pt(Pt(n)), 'toggleChatBot', function(e) {
              var t = n.props.toggleFloating;
              t ? t({ opened: e }) : n.setState({ opened: e });
            }),
            zt(Pt(Pt(n)), 'renderStep', function(e, t) {
            ...
            (n.state = {
              ...
              inputInvalid: !1,
              speaking: !1,
              recognitionEnable: e.recognitionEnable && ft.isSupported(),
              defaultUserSettings: {},
              textMode: !0
            }),
            (n.speak = xt(e.speechSynthesis)),
            n
          );
        }
        var n, i, a;
            ...
            },
            {
              ...
              value: function() {
                var e,
                  ...
                  E = d.headerTitle,
                  P = d.hideHeader,
                  z = d.hideSubmitButton,
                  C = d.inputOptionContainerStyle,
                  q = d.inputStyle,
                  N = d.placeholder,
                  M = d.inputAttributes,
                  R = d.inputOptionElements,
                  I = d.recognitionPlaceholder,
                  B = d.style,
                  T = d.submitButtonStyle,
                  A = d.width,
                  _ = d.height,
                  F =
                    k ||
                ...
                var V =
                  ...
                  L = l ? I : r.placeholder || N,
                  D = r.inputAttributes || M;
                return o.a.createElement(
                  'div',
                  ...
                  o.a.createElement(
                    ...
                    o.a.createElement(
                      ...
                      b &&
                        o.a.createElement(
                          nt,
                          { style: m, onClick: this.handleChangeButtton },
                          f ? S[0] : S[1]
                        ),
                      f &&
                        !r.hideInput &&
                      ...
                      !f && o.a.createElement(ot, { className: 'rsc-input-option', style: C }, R)
                    )
                  )
                );
              }
      ...
      (Ct.propTypes = {
        ...
        (Ct.defaultProps = {
          ...
          extraControl: void 0,
          floating: !1,
          floatingIcon: o.a.createElement(dt, null),
          floatingStyle: {},
          footerStyle: {},
          handleEnd: void 0,
