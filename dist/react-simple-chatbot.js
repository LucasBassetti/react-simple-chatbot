(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactSimpleChatbot"] = factory();
	else
		root["ReactSimpleChatbot"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ChatBot = __webpack_require__(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatBot = function (_Component) {
	  ...
	  function ChatBot(props) {
	    ...
	    _this.triggerNextStep = _this.triggerNextStep.bind(_this);
	  ...
	  _createClass(ChatBot, [{
	    ...
	    value: function componentWillMount() {
	      var _props = this.props,
	          ...
	          botBubbleColor = _props.botBubbleColor,
	          botFontColor = _props.botFontColor,
	          userAvatar = _props.userAvatar,
	          userBubbleColor = _props.userBubbleColor,
	          userFontColor = _props.userFontColor;
	      ...
	      for (var i = 0, len = this.props.steps.length; i < len; i += 1) {
	        var step = this.props.steps[i];
	
	        steps[step.id] = Object.assign({}, step, defaulBotSettings);
	      }
	
	      var currentStep = this.props.steps[0];
	      var renderedSteps = [steps[currentStep.id]];
	      var previousSteps = [steps[currentStep.id]];
	
	      this.setState({
	        defaulBotSettings: defaulBotSettings,
	        defaulUserSettings: defaulUserSettings,
	        steps: steps,
	    ...
	    value: function componentDidMount() {
	      var chatbotMain = document.querySelector('.simple-chatbot-main');
	    ...
	    key: 'triggerNextStep',
	    value: function triggerNextStep(value) {
	      var _state = this.state,
	          renderedSteps = _state.renderedSteps,
	          previousSteps = _state.previousSteps,
	          steps = _state.steps,
	          defaulUserSettings = _state.defaulUserSettings;
	      var _state2 = this.state,
	          currentStep = _state2.currentStep,
	          previousStep = _state2.previousStep;
	
	      var isEnd = currentStep.end;
	      ...
	      if (isEnd) {
	        ...
	        var isReplace = currentStep.replace && !currentStep.option;
	        ...
	        if (currentStep.options) {
	          var option = currentStep.options.filter(function (o) {
	            return o.value === value;
	          })[0];
	          delete currentStep.options;
	
	          currentStep = Object.assign({}, currentStep, option, defaulUserSettings, {
	            user: true,
	          ...
	          var nextSteps = Object.assign({}, steps[currentStep.trigger]);
	          nextSteps.key = (0, _randomId2.default)(24);
	          ...
	          if (nextSteps.user && !nextSteps.component) {
	            ...
	            this.setState({ renderedSteps: renderedSteps, previousSteps: previousSteps });
	          }
	        }
	      }
	    }
	    ...
	    value: function handleEnd() {
	      ...
	      var steps = previousSteps.map(function (step) {
	        var id = step.id,
	    ...
	    key: 'checkLastPosition',
	    value: function checkLastPosition(step) {
	      var renderedSteps = this.state.renderedSteps;
	
	      var length = renderedSteps.length;
	      ...
	      var isLast = step.user !== renderedSteps[stepIndex + 1].user;
	      return isLast;
	    }
	  }, {
	    key: 'checkFirstPosition',
	    value: function checkFirstPosition(step) {
	      var renderedSteps = this.state.renderedSteps;
	      ...
	      var isFirst = step.user !== renderedSteps[stepIndex - 1].user;
	      return isFirst;
	    }
	  }, {
	    key: 'handleKeyPress',
	    value: function handleKeyPress(event) {
	      if (event.key === 'Enter') {
	        var _state3 = this.state,
	            ...
	            previousSteps = _state3.previousSteps,
	            inputValue = _state3.inputValue,
	            defaulUserSettings = _state3.defaulUserSettings;
	        ...
	        if (!isInvalid) {
	          ...
	          currentStep = Object.assign({}, currentStep, defaulUserSettings, step);
	    ...
	    key: 'checkInvalidInput',
	    value: function checkInvalidInput() {
	      var _this2 = this;
	    ...
	    value: function renderStep(step, index) {
	      ...
	      var previousStep = stepIndex > 0 ? renderedSteps[stepIndex - 1] : {};
	
	      for (var i = 0, len = previousSteps.length; i < len; i += 1) {
	        var ps = previousSteps[i];
	      ...
	      if (component) {
	        return _react2.default.createElement(_steps.CustomStep, {
	          key: index,
	          step: step,
	          steps: steps,
	          style: customStyle,
	      ...
	      if (options) {
	        return _react2.default.createElement(_steps.OptionsStep, _extends({
	          key: index
	        }, step, {
	          triggerNextStep: this.triggerNextStep
	        }));
	      ...
	      return _react2.default.createElement(_steps.TextStep, _extends({
	        key: index
	      }, step, {
	    ...
	    value: function render() {
	      var _state6 = this.state,
	          ...
	          inputInvalid = _state6.inputInvalid,
	          renderedSteps = _state6.renderedSteps;
	      ...
	      var chatbotStyle = Object.assign({}, _ChatBot2.default.chatbot, style);
	      var chatbotMainStyle = Object.assign({}, _ChatBot2.default.chatbotMain, contentStyle);
	      var chatInputDisabledStyle = disabled ? _ChatBot2.default.chatInputDisabled : {};
	      var chatInputInvalidStyle = inputInvalid ? _ChatBot2.default.chatInputInvalid : {};
	      var chatInputStyle = Object.assign({}, _ChatBot2.default.chatInput, chatInputDisabledStyle, chatInputInvalidStyle, inputStyle);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _lodash2.default.map(renderedSteps, this.renderStep)
	        ),
	        _react2.default.createElement(
	          'div',
	          {
	    ...
	    value: function componentDidMount() {
	      ...
	      setTimeout(function () {
	        _this2.setState({ loading: false }, function () {
	          if (!step.user) {
	            _this2.props.triggerNextStep(step);
	          }
	        });
	      }, 500);
	    }
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        loading ? _react2.default.createElement(
	          'span',
	          { style: _CustomStep2.default.loading },
	          'Loading ...'
...
/***/ function(module, exports) {
	...
	var styles = {
	  loading: {
	    animation: 'chatbotLoading 1s infinite alternate'
	  },
	  customStep: {
	    display: 'flex',
	...
	var OptionsStep = function (_Component) {
	  ...
	  _createClass(OptionsStep, [{
	    ...
	    value: function renderOption(option) {
	      ...
	      var optionElementStyle = Object.assign({}, _OptionsStep2.default.optionElement, {
	      ...
	      return _react2.default.createElement(
	        'li',
	        {
	          ...
	          style: _OptionsStep2.default.option
	        },
	        _react2.default.createElement(
	          'a',
	          {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: 'chat-options-step' },
	        _react2.default.createElement(
	          'ul',
	          {
	            className: 'options',
	            style: _OptionsStep2.default.options
	          },
	          _lodash2.default.map(options, this.renderOption)
	        )
	      );
	    }
	  }]);
	...
	var TextStep = function (_Component) {
	  ...
	  _createClass(TextStep, [{
	    ...
	    value: function render() {
	      ...
	      var chatTextStepStyle = _TextStep2.default.chatTextStep;
	      var chatImageStyle = _TextStep2.default.chatImage;
	      var imageStyle = _TextStep2.default.image;
	      var chatContentStyle = _TextStep2.default.chatContent;
	
	      var chatContentPositionStyle = !isFirst && !isLast ? _TextStep2.default.middle : {};
	
	      if (!isFirst && isLast) {
	        chatContentPositionStyle = _TextStep2.default.last;
	      }
	
	      if (user) {
	        chatContentPositionStyle = !isFirst && !isLast ? _TextStep2.default.userMiddle : {};
	
	        if (!isFirst && isLast) {
	          chatContentPositionStyle = _TextStep2.default.userLast;
	        }
	
	        chatTextStepStyle = Object.assign({}, _TextStep2.default.chatTextStep, _TextStep2.default.userChatTextStep);
	        chatImageStyle = Object.assign({}, _TextStep2.default.chatImage, _TextStep2.default.userChatImage);
	        imageStyle = Object.assign({}, _TextStep2.default.image, _TextStep2.default.userImage);
	        chatContentStyle = Object.assign({}, _TextStep2.default.chatContent, _TextStep2.default.userChatContent, chatContentPositionStyle, {
	          background: bubbleColor,
	          color: fontColor
	        });
	      } else {
	        chatContentStyle = Object.assign({}, _TextStep2.default.chatContent, chatContentPositionStyle, {
	          background: bubbleColor,
	          color: fontColor
	        });
	      }
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          isFirst && _react2.default.createElement('img', {
	            className: 'image',
	            style: imageStyle,
	            src: avatar,
	            alt: 'avatar'
	        ...
	        _react2.default.createElement(
	          ...
	          this.state.loading && _react2.default.createElement(
	            'span',
	            { style: _TextStep2.default.loading },
	            '...'
	          ),
